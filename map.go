...
// below is from:
// https://cs.opensource.google/go/go/+/refs/tags/go1.23.2:src/sync/map.go
// Added generic params, removed CompareAndX methods, and used unsafe.Pointer for expunged var.
