...
// removed TestMapRangeNoAllocations, TestMapClearNoAllocations, and CompareAndX ops.
// TestMapMatchesStdMap checks between syncmap and StdMap, similar to TestMapMatchesRWMutex.
